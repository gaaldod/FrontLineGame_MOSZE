...
| Név | Feladatkör |
| :--- | :--- |
| **Gaál Dominik** | UI, MI logika, modellek, mentéskezelés |
| **Waldmann Lőrinc Zsolt** | UI, csata kezelés, fő játék loop, tesztelés |
| **Fejér Máté** | Sztori, artwork |
| **Boros Martin** | Intro |
| **Merész Dávid Róbert** | Readme, gameplay video|
